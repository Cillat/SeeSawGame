...
/// Resources/BGMかResources/SEにあるやつを最初にすべて読み込む
/// 使い方：AudioManager.Instance.PlaySE("niku_eat");
/// みたいな感じ（拡張子はいらない）
/// </summary>
...
public class AudioManager : MonoBehaviour
{
    ...
    private const int SE_SOURCE_NUM = 20;  //最高同時再生音源の数
    ...
    private void Awake()
    {
        ...
        {
            Debug.Log("destroy this audio manager");
            Destroy(gameObject);
            return;
        }
    ...
    public void PlayBGM(string bgmName, float fadeSpeedRate = BGM_FADE_SPEED_RATE_HIGH)
    {
        ...
        {
            Debug.LogError(bgmName + "という名前のBGMがありません");
            return;
        }
